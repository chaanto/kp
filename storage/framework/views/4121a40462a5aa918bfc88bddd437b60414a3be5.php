...
<?php $__env->startSection('title', 'Data Supplier - Purchasing App'); ?>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <div class="mb-4">
            <a href="<?php echo e(route('suppliers.create')); ?>" type="button" class="btn btn-primary btn-rounded">
              + Add New Record</a>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectKp\sistem-keuangan\resources\views/supplier/index.blade.php ENDPATH**/ ?>