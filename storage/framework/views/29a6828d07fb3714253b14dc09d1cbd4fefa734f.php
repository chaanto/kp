...
<?php $__env->startSection('title', 'Neraca - Laporan'); ?>
      ...
      <div class="card">
        <div class="card-body">
          <form method="POST" enctype="multipart/form-data"
            action="<?php echo e(route('neraca.print')); ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-md-6">
...
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectKp\kp\resources\views/neraca/index.blade.php ENDPATH**/ ?>