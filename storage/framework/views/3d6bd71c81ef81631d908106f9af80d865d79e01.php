...
<?php $__env->startSection('title', 'SIMAC'); ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?php echo e(asset('images/users/widget-table-pic1.jpg')); ?>"
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?php echo e(asset('images/users/widget-table-pic2.jpg')); ?>"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?php echo e(asset('images/users/widget-table-pic3.jpg')); ?>"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td class="px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?php echo e(asset('images/users/widget-table-pic4.jpg')); ?>"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
...
<script src="<?php echo e(asset('extra-libs/jvector/jquery-jvectormap-2.0.2.min.js')); ?>"></script>
<script src="<?php echo e(asset('extra-libs/jvector/jquery-jvectormap-world-mill-en.js')); ?>"></script>
<script src="<?php echo e(asset('dist/js/pages/dashboards/dashboard1.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectKp\sistem-keuangan\resources\views/home.blade.php ENDPATH**/ ?>