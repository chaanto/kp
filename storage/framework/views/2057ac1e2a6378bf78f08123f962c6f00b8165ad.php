...
<?php $__env->startSection('title', 'Data Purchasing - Purchasing App'); ?>
            ...
            <div class="card-body">
              <div class="mb-4">
                <div class="nav-item my-1">
                  <a href="<?php echo e(route('purchases.create')); ?>" type="button" class="btn btn-primary btn-rounded">
                    + Add New Record
                  </a>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  function datatable(status) {
    $table = $('.yajra-datatable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: `<?php echo e(url('purchase-list/${status}')); ?>`,
      columns: [{
              data: 'DT_RowIndex',
              name: 'DT_RowIndex'
          },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectKp\sistem-keuangan\resources\views/purchase/index.blade.php ENDPATH**/ ?>