        ...
        <table class='table'>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding:0px 0px 0px 0px; border:1px solid black;"  class="text-right border-0"><?php echo e(number_format($penjualan)); ?></td>
                </tr>
                <tr>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" ><p class="ml-4 mb-0">Penerimaan Pinjaman</p></td>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;"  class="text-right border-0"><?php echo e(number_format($pinjaman)); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($bahanPembantu)); ?></td>
                </tr>
                <tr>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;"><p class="ml-4 mb-0">Upah Buruh Produksi</p></td>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($buruh)); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($produksi)); ?></td>
                </tr>
                <tr>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;"><p class="ml-4 mb-0">Gaji Pimpinan</p></td>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($gajiBoss)); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($alatTulis)); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($asset)); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($angsuran)); ?></td>
                </tr>
                <tr>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;"><p class="ml-4 mb-0">Biaya Bunga</p></td>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($bunga)); ?></td>
                </tr>
                <tr>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;"><p class="ml-4 mb-0">Biaya Pajak</p></td>
                    <td style="padding:0px 3px 0px 3px; border:1px solid black;" class="text-right border-0"><?php echo e(number_format($pajak)); ?></td>
                </tr>
                <tr>
