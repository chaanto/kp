...
<?php $__env->startSection('title', 'Data Jurnal - Purchasing App'); ?>
            ...
            <div class="card-body">
              <div class="mb-4">
                <div class="nav-item my-1">
                  <a href="<?php echo e(route('jurnals.create')); ?>" type="button" class="btn btn-primary btn-rounded">
                    + Add New Record
                  </a>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  function datatable(status) {
    $table = $('.yajra-datatable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: `<?php echo e(url('jurnal-list')); ?>`,
      columns: [
          {
              data: 'transaction_no',
              name: 'transaction_no'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectKp\sistem-keuangan\resources\views/jurnal/index.blade.php ENDPATH**/ ?>