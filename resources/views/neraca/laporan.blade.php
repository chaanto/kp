            ...
            <table class='table w-100' style="border: 1px solid black;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  style="border:none;padding:2px 2px 2px 2px;"class="text-right border-0">{{number_format($cashTotal) }}</td>
                    </tr>
                        <tr>
                            <td style="border:none;padding:2px 2px 2px 2px;"><p class="ml-4 mb-0">Akun Piutang</p></td>
                            <td style="border:none;padding:2px 2px 2px 2px;" class="text-right border-0">{{number_format($ar)}}</td>
                        </tr>
                    <tr>
                        <td style="border:none;padding:2px 2px 2px 2px;"><p class="ml-4 mb-0">Persediaan</p></td>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right border-0">{{number_format($totalPersediaan) }}</td>
                    </tr>
                    <tr>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="font-weight-bold">Total Aktiva Lancar</td>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right font-weight-bold border-0">{{number_format($totalAktivaLancar) }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right border-0">{{number_format($totalKendaraan)}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right font-weight-bold border-0">{{number_format($totalAktiva)}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class='table w-100' style="border: 1px solid black;border-left:none;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right border-0">{{number_format($ap)}}</td>
                    </tr>
                    <tr>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="font-weight-bold">Total Kewajiban Jangka Pendek</td>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right font-weight-bold border-0">{{number_format($pasivaJP)}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right border-0">{{number_format($totalWesel)}}</td>
                    </tr>
                    <tr>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="font-weight-bold">Total Kewajiban Jangka Panjang</td>
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right font-weight-bold border-0">{{number_format($pasivaJPan)}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:none;padding:2px 2px 2px 2px;" class="text-right font-weight-bold border-0">{{number_format($totalKewajibanDanModal)}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
